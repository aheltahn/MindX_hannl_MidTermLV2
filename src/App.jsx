...
const data = [
  {
    ...
    "image": "https://i.ytimg.com/vi/DdJXOvtNsCY/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBtCK5Mt34gxqosPfxgyqdQXqaMCw",
    "episode": "01"
},
{
    "id": "2",
...
},
{
    ...
    "image": "https://static2.vieon.vn/vieplay-image/poster_v4/2022/05/20/d4ppmz00_660x946-spyxfamily-demoa2731c005ce704ec40c7ff515b2b1afb.jpg",
    "episode": "07"
},
{
    "id": "5",
    ...
    "image": "https://cdn.popsww.com/blog/sites/2/2022/02/Mot-vai-nhan-vat-chinh-trong-truyen--781x1080.jpg",
    "episode": "28"
},
{
    "id": "6",
    ...
    "image": "https://m.media-amazon.com/images/M/MV5BOGQyYTAxZDctNTlhNS00MzJhLWE5ODQtMDY0ZDNmNTZhODFkXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
    "episode": "28"
},
{
    "id": "7",
    ...
    "image": "https://image.lag.vn/upload/news/21/10/29/teaservisual_SJBD.jpg",
    "episode": "28"
},
];

const App = () => {
  const [selectMovie, setSelectionMovie] = useState(data[0]);

  return (
    <div className="bg-gray-900 pl-8 pr-8 min-h-screen text-white font-sans">
   <Header></Header>
   <Banner movie={selectMovie} ></Banner>
   <NewRelease movieList={data} onSelect={setSelectionMovie}></NewRelease>
    </div>
);
};
